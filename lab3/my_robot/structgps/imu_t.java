...
public final class imu_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(structgps.imu_t.class))
            return 0L;
 
        classes.add(structgps.imu_t.class);
    ...
    public static structgps.imu_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        structgps.imu_t o = new structgps.imu_t();
    ...
    public structgps.imu_t copy()
    {
        structgps.imu_t outobj = new structgps.imu_t();
        outobj.yaw = this.yaw;
